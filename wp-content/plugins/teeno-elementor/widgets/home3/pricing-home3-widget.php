 ...
 * @since 1.0.0
 */
class BdevsPricingHome3Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-pricing-home3-widget';
	}
	...
	public function get_title() {
		return __( 'Pricing Home3 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'pricinghome3widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Home3 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Pricing Home3 Widget Item', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="pricing-area pricing-2 pb-75">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title title-center mb-50" data-aos="fade-up">
                    <span class="color-primary"><?php echo wp_kses_post($settings['title']); ?></span>
                    <h2 class="title mb-15 mt-0"><?php echo wp_kses_post($settings['subtitle']); ?></h2>
                    <p class="text">
                    ...
                    <div class="tab-switch mt-30">
                        ...
                        <label class="tab-switch-toggle">
                            ...
                            <span class="switch-toggle-slider bg-gradient"></span>
                        </label>
							...
							?>
	                            <div class="col-md-6 col-lg-4 item" data-aos="fade-up">
	                                <div class="pricing-item mb-30 bg-primary-light radius-lg">
	                                    ...
	                                    <div class="mt-20">
	                                        <a href="<?php echo wp_kses_post($item['link_btn']); ?>"
	                                            class="btn btn-lg btn-block btn-primary no-animation bg-gradient rounded-pill" title="Choose"
	                                            target="_self"><?php echo wp_kses_post($item['btn']); ?></a>
	                                    </div>
	                                </div>
	                            </div>
	                        <?php endforeach; ?>
