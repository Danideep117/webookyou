 ...
 * @since 1.0.0
 */
class BdevsSliderHome3Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-slider-home3-widget';
	}
	...
	public function get_title() {
		return __( 'Slider Home3 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'sliderhome3widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Home3 Widget', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="hero-banner hero-banner-3 bg-cover bg-img" data-bg-image="<?php echo esc_url($settings['big_image']['url']); ?>">
    <div class="container">
