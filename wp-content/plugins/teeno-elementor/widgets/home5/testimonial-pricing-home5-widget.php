 ...
 * @since 1.0.0
 */
class BdevsTestimonialPricingHome5Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-testimonial-pricing-home5-widget';
	}
	...
	public function get_title() {
		return __( 'Testimonial Pricing Home5 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'testimonialpricinghome5widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Testimonial Pricing Home5 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Testimonial Home5 Widget Item', 'bdevs-elementor' ),
		...
		$this->add_control(
			'tabs2',
			[
				'label' => esc_html__( 'Pricing Home5 Widget Item', 'bdevs-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title'   => esc_html__( 'Slide #1', 'bdevs-elementor' ),
