 ...
 * @since 1.0.0
 */
class BdevsTeamHome5Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-team-home5-widget';
	}
	...
	public function get_title() {
		return __( 'Team Home5 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'teamhome5widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Team Home5 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Team Home5 Widget Item', 'bdevs-elementor' ),
