 ...
 * @since 1.0.0
 */
class BdevsNewsletterWidget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-newsletter-widget';
	}
	...
	public function get_title() {
		return __( 'Newsletter Blog Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'newsletterwidget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_newsletter_widget',
			[
				'label' => esc_html__( 'Newsletter Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'subimage',
			[
				'label'       => esc_html__( 'Subimage Section', 'bdevs-elementor' ),
				'type'        => Controls_Manager::MEDIA,
				'dynamic'     => [ 'active' => true ],
				'label_block' => true,
				'description' => esc_html__( 'Upload image section', 'bdevs-elementor' ),
            ...
            <div class="row align-items-center" data-aos="fade-up">
                    ...
                    <div class="content ptb-30">
                        ...
                        <div class=" btn-groups mt-30">
                            <a href="<?php echo wp_kses_post($settings['link_apple']); ?>" class="btn btn-img radius-md" title="App Store" target="_blank">
                                <img class="lazyload blur-up" src="<?php echo esc_url($settings['subimage']['url']); ?>" data-src="<?php echo esc_url($settings['image_apple']['url']); ?>" alt="App Store">
                            </a>
                            <a href="<?php echo wp_kses_post($settings['link_gg']); ?>" class="btn btn-img radius-md" title="Play Store" target="_blank">
                                <img class="lazyload blur-up" src="<?php echo esc_url($settings['subimage']['url']); ?>" data-src="<?php echo esc_url($settings['image_gg']['url']); ?>" alt="App Store">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-end">
                    <div class="image d-none d-lg-block">
                        <img class="lazyload blur-up" src="<?php echo esc_url($settings['subimage']['url']); ?>" data-src="<?php echo esc_url($settings['image']['url']); ?>" alt="Image">
                    </div>
                </div>
            </div>
        </div>
