 ...
 * @since 1.0.0
 */
class BdevsTestimonialBlogWidget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-testimonial-blog-widget';
	}
	...
	public function get_title() {
		return __( 'Testimonial Blog Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'testimonialblogwidget', 'carousel' ];
	}
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="testimonial-area testimonial-3 pt-0">
    <div class="spacer pt-100"></div>
