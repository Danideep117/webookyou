 ...
 * @since 1.0.0
 */
class BdevsBlogWidget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Blog Area Widget ', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Blog Widget', 'bdevs-elementor' ),
			]
		);
                ...
                <article class="card mb-25 radius-md">
                    <div class="card-img">
                        <a href="<?php the_permalink(); ?>" target="_self" title="Link" class="lazy-container ratio ratio-1-1">
                            <img class="lazyload" src="<?php echo wp_get_attachment_url($img);?>" data-src="<?php echo wp_get_attachment_url($img);?>" alt="Blog Image">
                        </a>
                    </div>
