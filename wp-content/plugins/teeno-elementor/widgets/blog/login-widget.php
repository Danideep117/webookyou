 ...
 * @since 1.0.0
 */
class BdevsLoginWidget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Login Widget ', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_login_widget',
			[
				'label' => esc_html__( 'Login Widget', 'bdevs-elementor' ),
			]
		);
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="main-form">
                                ...
                                <?php print do_shortcode('[user_registration_my_account]'); ?>
                            </div>
                        </div>
                    </div>
                </div>
