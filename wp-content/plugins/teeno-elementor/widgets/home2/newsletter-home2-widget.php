 ...
 * @since 1.0.0
 */
class BdevsNewsletterHome2Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-newsletter-home2-widget';
	}
	...
	public function get_title() {
		return __( 'Newsletter Home2 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'newsletterhome2widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Newsletter Home2 Widget', 'bdevs-elementor' ),
			]
		);
