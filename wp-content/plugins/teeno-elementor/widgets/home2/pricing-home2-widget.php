 ...
 * @since 1.0.0
 */
class BdevsPricingHome2Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-pricing-home2-widget';
	}
	...
	public function get_title() {
		return __( 'Pricing Home2 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'pricinghome2widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Pricing Home2 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Pricing Home2 Widget Item', 'bdevs-elementor' ),
	                                ...
	                                <div class="pricing-item mb-30 bg-primary-light radius-lg">
	                                    ...
	                                    <div class="mt-20">
	                                        <a href="<?php echo wp_kses_post($item['link_btn']); ?>" 
	                                        	class="btn btn-lg btn-block btn-primary no-animation rounded-pill" title="Choose" target="_self"><?php echo wp_kses_post($item['btn']); ?></a>
	                                    </div>
	                                </div>
	                            </div>
                            <?php endforeach; ?>
