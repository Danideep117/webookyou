 ...
 * @since 1.0.0
 */
class BdevsSliderHome4Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-slider-home4-widget';
	}
	...
	public function get_title() {
		return __( 'Slider Home4 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'sliderhome4widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Home4 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'client_img',
			[
				'label'       => __( 'Client', 'bdevs-elementor' ),
				'type'        => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Enter your title', 'bdevs-elementor' ),
				'default'     => __( '', 'bdevs-elementor' ),
				'label_block' => true,
        ...
        <div class="row align-items-center gx-xl-5">
            <div class="col-lg-6">
                <div class="banner-content mb-40">
                    ...
                    <p class="text" data-aos="fade-up" data-aos-delay="100"><?php echo wp_kses_post($settings['subtitle']); ?>
                    </p>
