 ...
 * @since 1.0.0
 */
class BdevsTestimonialHome4Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-testimonial-home4-widget';
	}
	...
	public function get_title() {
		return __( 'Testimonial Home4 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'testimonialhome4widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Testimonial Home4 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Testimonial Home4 Widget Item', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="testimonial-area ptb-100 bg-cover bg-img" data-bg-image="<?php echo esc_url($settings['image']['url']); ?>">
    <div class="container">
        <div class="row">
            <div class="col-12">
