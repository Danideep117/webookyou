 ...
 * @since 1.0.0
 */
class BdevsScreenshotHome4Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-screenshot-home4-widget';
	}
	...
	public function get_title() {
		return __( 'Screenshot Home4 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'screenshothome4widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Screenshot Home4 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Screenshot Home4 Widget Item', 'bdevs-elementor' ),
