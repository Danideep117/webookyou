 ...
 * @since 1.0.0
 */
class BdevsBlogHome7Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-blog-home7-widget';
	}
	...
	public function get_title() {
		return __( 'Blog Home7 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'bloghome7widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Blog Home7 Widget', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="blog-area blog-5 pt-100 pb-70 bg-secondary-light">
    <div class="container">
        <div class="row">
            <div class="col-12">
	                        ...
	                        <article class="card mb-30 radius-0">
	                            ...
	                            <div class="card-content p-30">
	                                ...
	                                <p class="card-text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt
	                                	<?php if(isset($teeno_redux_demo['blog_excerpt2'])){?>
	                                    <?php echo esc_attr(teeno_excerpt_4($teeno_redux_demo['blog_excerpt2'])); ?>
	                                    <?php }else{?>
	                                    <?php echo esc_attr(teeno_excerpt_4(8)); }?>
	                                </p>
	                            </div>
	                        </article>
	                    </div>
