 ...
 * @since 1.0.0
 */
class BdevsTeamHome7Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-team-home7-widget';
	}
	...
	public function get_title() {
		return __( 'Team Home7 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'teamhome7widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Team Home7 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Team Home7 Widget Item', 'bdevs-elementor' ),
				...
				'fields' => [
					...
					[
						'name'        => 'social_item',
						'label'       => esc_html__( 'Social Item', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="team-area team-2 ptb-100">
    <div class="container">
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item bg-primary-light">
                                    <div class="shape-content bg-img" data-bg-image="<?php echo esc_url($item['big_image']['url']); ?>">
                                        ...
                                        <span class="post color-white font-sm"><?php echo wp_kses_post($item['job']); ?></span>
                                    </div>
                                    <div class="social-link style-2 mt-20">
                                        <?php echo wp_kses_post($item['social_item']); ?>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
