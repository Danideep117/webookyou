 ...
 * @since 1.0.0
 */
class BdevsSliderHome6Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-slider-home6-widget';
	}
	...
	public function get_title() {
		return __( 'Slider Home6 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'sliderhome6widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Home6 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Slider Home6 Widget Item', 'bdevs-elementor' ),
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="hero-banner hero-banner-6 bg-img pb-120" data-bg-image="<?php echo esc_url($settings['big_image']['url']); ?>">
    <!-- Hero Area -->
            ...
            <div class="row gx-xl-5">
                ...
                <div class="col-lg-6" data-aos="fade-up">
                    <div class="banner-image mb-40">
                        <img class="lazyload blur-up" data-src="<?php echo esc_url($settings['hero_img']['url']); ?>" alt="Banner Image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="counter-area counter-3">
                <div class="row">
                	<?php
					   ...
					   $idd++;
					?>
                    <div class="col-lg-3 col-sm-6 item" data-aos="fade-up">
    ...
    <div class="hero-shape bg-img d-none d-lg-block" data-bg-image="<?php echo esc_url($settings['counter_img']['url']); ?>"></div>
    <div class="dot-shapes">
        <img src="<?php echo esc_url($settings['counter_img1']['url']); ?>" alt="Shape" class="dot-one">
        <img src="<?php echo esc_url($settings['counter_img1']['url']); ?>" alt="Shape" class="dot-two">
    </div>
</section>
<?php
}
