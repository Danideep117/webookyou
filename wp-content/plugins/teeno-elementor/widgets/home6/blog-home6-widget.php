 ...
 * @since 1.0.0
 */
class BdevsBlogHome6Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-blog-home6-widget';
	}
	...
	public function get_title() {
		return __( 'Blog Home6 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'bloghome6widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Blog Home6 Widget', 'bdevs-elementor' ),
			]
		);
