 ...
 * @since 1.0.0
 */
class BdevsAboutHome6Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-about-home6-widget';
	}
	...
	public function get_title() {
		return __( 'About Home6 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'abouthome6widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'About Home6 Widget', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="about-area about-4">
    <div class="container">
