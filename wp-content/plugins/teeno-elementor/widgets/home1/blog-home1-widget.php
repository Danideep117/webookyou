 ...
 * @since 1.0.0
 */
class BdevsBlogHome1Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-blog-home1-widget';
	}
	...
	public function get_title() {
		return __( 'Blog Home1 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'bloghome1widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_blog_widget',
			[
				'label' => esc_html__( 'Blog Home1 Widget', 'bdevs-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Our Teeno Journal', 'bdevs-elementor' ),
				'label_block' => true,
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your title', 'bdevs-elementor' ),
				'default'     => __( 'Read Our Blog Post', 'bdevs-elementor' ),
				'label_block' => true,
			]	
		);
            ...
            <div class="col-12">
                <div class="col-12">
                    <div class="section-title title-inline mb-50" data-aos="fade-up">
                        ...
                        <a href="<?php echo wp_kses_post($settings['link_btn']); ?>"><button class="btn btn-lg btn-primary" type="button" aria-label="Read Now"><?php echo wp_kses_post($settings['btn']); ?></button></a>
                    </div>
                </div>
            </div>
            <div class="col-12">
		            ...
		            <?php $img = get_post_meta(get_the_ID(),'_cmb_img', true); ?>
	                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
	                        <article class="card mb-25 radius-md">
	                            <div class="card-img">
	                                <a href="<?php the_permalink(); ?>" target="_self" title="Link" class="lazy-container ratio ratio-1-1">
	                                    <img class="lazyload" data-src="<?php echo wp_get_attachment_url($img);?>" alt="Blog Image">
	                                </a>
	                            </div>
