 ...
 * @since 1.0.0
 */
class BdevsAboutHome1Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-about-home1-widget';
	}
	...
	public function get_title() {
		return __( 'About Home1 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'abouthome1widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_about_home1_widget',
			[
				'label' => esc_html__( 'About Home1 Widget', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="about-area about-1 pb-60">
    <div class="container">
