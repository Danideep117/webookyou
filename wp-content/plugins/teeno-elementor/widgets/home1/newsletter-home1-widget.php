 ...
 * @since 1.0.0
 */
class BdevsNewsletterHome1Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-newsletter-home1-widget';
	}
	...
	public function get_title() {
		return __( 'Newsletter Home1 Widget ', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'newsletterhome1widget', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Newsletter Home1 Widget', 'bdevs-elementor' ),
			]
		);
	...
	public function render() {
		...
		extract($settings);
		?>
<section class="newsletter-area newsletter-1 pb-100">
    <div class="container">
