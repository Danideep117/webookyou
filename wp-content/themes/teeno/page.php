...
?>
<?php if(isset($teeno_redux_demo['blog_bg_light']['url']) && $teeno_redux_demo['blog_bg_light']['url'] != ''){?>
<section class="section bg-dark bg-theme" data-img-url="<?php echo esc_url($teeno_redux_demo['blog_bg_light']['url']); ?>">
<?php }else{?>
					...
					<div class="single-blog-box">
						...
						<div class="single-blog-content">
							<ul class="metadata">
								...
								<li class="metadata_item">
									<?php comments_number( esc_html__('0 Comments', 'teeno'), esc_html__('1 Comment', 'teeno'), esc_html__('% Comments', 'teeno') ); ?>
								</li>
							</ul>
							<?php the_content(); ?>
						</div>
