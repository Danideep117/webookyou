    ...
    <div class="container">
        <div class="content text-center">
            <h2>
                <?php
                    if ( is_day() ) :
                        printf( esc_html__( 'Daily Archives: %s', 'teeno' ), get_the_date() );
                    elseif ( is_month() ) :
                        printf( esc_html__( 'Monthly Archives: %s', 'teeno' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'teeno' ) ) );
                    elseif ( is_year() ) :
                        printf( esc_html__( 'Yearly Archives: %s', 'teeno' ), get_the_date( _x( 'Y', 'yearly archives date format', 'teeno' ) ) );
                    else :
                        echo esc_html__( 'Archives', 'teeno' );
                    endif;
                ?>
            </h2>
        </div>
