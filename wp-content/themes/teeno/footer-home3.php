...
<!-- Start Footer 
    ============================================= -->
    <footer class="footer-area radius-0 mt-negative">
        <div class="overlay bg-img opacity-1 bg-primary-light" data-bg-image="assets/images/footer-bg-1.png"></div>
                        ...
                        <div class="footer-widget" data-aos="fade-up" data-aos-delay="100">
                            <div class="navbar-brand">
                                <a href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Link">
                                    <?php if (isset($teeno_redux_demo['logo_footer3']['url']) && $teeno_redux_demo['logo_footer3']['url'] != '') {?>
                                    <img class="lazyload blur-up" src="<?php echo esc_url($teeno_redux_demo['logo_footer3']['url']); ?>" alt="Brand Logo">
                                    <?php } else { ?>
                                    <img class="lazyload blur-up" src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-3-1.png" alt="Brand Logo"/>
                                    <?php } ?>
                                </a>
                            </div>
