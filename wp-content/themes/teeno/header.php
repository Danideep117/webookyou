            ...
            <div class="container">
                ...
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Teeno">
                        <?php if (isset($teeno_redux_demo['logo_header']['url']) && $teeno_redux_demo['logo_header']['url'] != '') {?>
                        <img src="<?php echo esc_url($teeno_redux_demo['logo_header']['url']); ?>" class="logo-display" alt="Brand logo">
                        <?php } else { ?>
                        <img src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-1.png" class="logo-display" alt="Brand logo"/>
                        <?php } ?>
                    </a>
                </div>
                <!-- Menu toggle button -->
