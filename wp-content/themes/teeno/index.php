...
<?php }?>
    <div class="container">
        <div class="content text-center">
            <h2>
                <?php if(isset($teeno_redux_demo['heading_blog'])){?>
                <?php echo esc_attr($teeno_redux_demo['heading_blog']);?>
                <?php }else{?>
                <?php echo esc_html__( 'Latest Blogs', 'teeno' );}?>
            </h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">
                    <?php if(isset($teeno_redux_demo['subheading_blog'])){?>
                    <?php echo esc_attr($teeno_redux_demo['subheading_blog']);?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Blogs', 'teeno' );}?>
                  </li>
                </ol>
            </nav>
        </div>
