...
<head>
	...
	<link rel="icon" href="<?php if(isset($teeno_redux_demo['favicon2']['url'])){?><?php echo esc_url($teeno_redux_demo['favicon2']['url']); ?><?php }?>">
	<?php }?> 
	<?php wp_head(); ?>
</head>
<body class="theme-color-2">
    ...
    <!-- Header-area start -->
    <header class="header-area pt-0 bg-white" data-aos="fade-down">
        <!-- Start mobile menu -->
            ...
            <div class="container">
                ...
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Teeno">
                        <?php if (isset($teeno_redux_demo['logo_header2']['url']) && $teeno_redux_demo['logo_header2']['url'] != '') {?>
                        <img src="<?php echo esc_url($teeno_redux_demo['logo_header2']['url']); ?>" class="logo-display" alt="Brand logo">
                        <?php } else { ?>
                        <img src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-2.png" class="logo-display" alt="Brand logo"/>
                        <?php } ?>
                    </a>
                </div>
                <!-- Menu toggle button -->
                        ...
                        <ul id="mainMenu" class="navbar-nav mobile-item mx-auto align-items-xl-center">
                            <?php 
                                ...
                                array( 
                                    ...
                                    'link_before'     => '',
                                    'link_after'      => '',
                                    'items_wrap'      => '<ul class="navbar-nav mobile-item mx-auto align-items-xl-center %2$s"> %3$s </ul>',
                                    'depth'           => 0, 
                                    )
                            ); ?>
