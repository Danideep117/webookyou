        ...
        <div class="footer-top pt-100 pb-70">
            <div class="container">
                <div class="row justify-content-between">
                        ...
                        <div class="footer-widget" data-aos="fade-up" data-aos-delay="100">
                            <div class="navbar-brand">
                                <a href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Link">
                                    <?php if (isset($teeno_redux_demo['logo_footer2']['url']) && $teeno_redux_demo['logo_footer2']['url'] != '') {?>
                                    <img class="lazyload blur-up" src="<?php echo esc_url($teeno_redux_demo['logo_footer2']['url']); ?>" alt="Logo">
                                    <?php } else { ?>
                                    <img class="lazyload blur-up" src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-2.png" alt="Logo"/>
                                    <?php } ?>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="footer-widget" data-aos="fade-up" data-aos-delay="200">
                            <?php if ( is_active_sidebar( 'footer-area-9' ) ) : ?>
                               <?php dynamic_sidebar( 'footer-area-9' ); ?>
                            <?php endif; ?>
                            <div class="newsletter-form">
                                <?php echo do_shortcode($teeno_redux_demo['shortcode']); ?>
                            </div>
                        </div>
                    </div>
                </div>
