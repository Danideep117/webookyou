...
<head>
	...
	<link rel="icon" href="<?php if(isset($teeno_redux_demo['favicon4']['url'])){?><?php echo esc_url($teeno_redux_demo['favicon4']['url']); ?><?php }?>">
	<?php }?> 
	<?php wp_head(); ?>
</head>
            ...
            <div class="container">
                ...
                <div class="logo">
                    <a href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Teeno">
                        <?php if (isset($teeno_redux_demo['logo_header4']['url']) && $teeno_redux_demo['logo_header4']['url'] != '') {?>
                        <img src="<?php echo esc_url($teeno_redux_demo['logo_header4']['url']); ?>" alt="Brand logo">
                        <?php } else { ?>
                        <img src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-4.png" alt="Brand logo"/>
                        <?php } ?>
                    </a>
                </div>
                <!-- Menu toggle button -->
                    ...
                    <div class="collapse navbar-collapse">
                        <ul id="mainMenu" class="navbar-nav mobile-item mx-auto align-items-xl-center">
                            ...
                            <li class="nav-item logo">
                                <a class="navbar-brand nav-link" href="<?php echo esc_url(home_url('/')); ?>" target="_self" title="Teeno">
                                    <?php if (isset($teeno_redux_demo['logo_header4']['url']) && $teeno_redux_demo['logo_header4']['url'] != '') {?>
                                    <img src="<?php echo esc_url($teeno_redux_demo['logo_header4']['url']); ?>" alt="Brand logo">
                                    <?php } else { ?>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/logo/logo-4.png" alt="Brand logo"/>
